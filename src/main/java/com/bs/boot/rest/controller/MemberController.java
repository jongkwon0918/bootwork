...
import com.bs.boot.common.aop.MyAspect;
...
public class MemberController {
    ...
    private final MyAspect myAspect;
	private final MemberService service;
	
	public MemberController(
			@Qualifier("JpaMemberService") MemberService service, MyAspect myAspect, CommandLineRunner commandLineRunner) {
	...
	/*
	 * @GetMapping("/member") public ResponseEntity<List<MemberDTO>>
	 * searchParam(@RequestParam Map param){
	 * 
	 * }
	 */
