/*const serverUrl = "localhost:9999/chatting";*/
const serverUrl="203.253.175.213:9999/chatting";

//접속 url주소
// http -> ws://서버주소:포트/서비스 주소
// https -> wss://서버주소:포트/서비스 주소
...
server.onmessage = response => {
    //서버에서 send()했을때 실행
    //response.data속성에 서버에서 보낸 데이터가 저장되어 있음
    ...
    switch (receiveData.type) {
        case "open":
        case "close": alertMessage(receiveData); break;
